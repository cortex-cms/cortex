module V1
  module Entities
    class Webpage < Grape::Entity
      ...
      expose :product_information_widget_json, documentation:  {type: 'Hash', is_array: true, desc: 'Product Information Widget Data as JSON'}
      expose :slider_widget_json, documentation:  {type: 'Hash', is_array: true, desc: 'Slider Widget Data as JSON'}
      expose :card_group_widget_json, documentation:  {type: 'Hash', is_array: true, desc: 'Card Group Widget Data as JSON'}
      ...
      with_options if: { full: true } do
        ...
        expose :product_information_widget_yaml, documentation:  {type: 'Hash', is_array: true, desc: 'Product Information Widget Data as YAML'}
        expose :slider_widget_yaml, documentation:  {type: 'Hash', is_array: true, desc: 'Slider Widget Data as YAML'}
        expose :card_group_widget_yaml, documentation:  {type: 'Hash', is_array: true, desc: 'Card Group Widget Data as YAML'}

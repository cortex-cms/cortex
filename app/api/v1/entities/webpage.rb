module V1
  module Entities
    class Webpage < Grape::Entity
      ...
      expose :leaders_widget_json, documentation:  {type: 'Hash', is_array: true, desc: 'Leaders Widget Data as JSON'}
      ...
      with_options if: { full: true } do
        ...
        expose :leaders_widget_yaml, documentation:  {type: 'Hash', is_array: true, desc: 'Leaders Widget Data as YAML'}

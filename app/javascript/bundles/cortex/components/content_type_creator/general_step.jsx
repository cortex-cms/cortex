...
class GeneralStep extends React.PureComponent {
  ...
  renderIconList = () => this.IconNames.map((icon, index) => <MenuItem key={index} className='content-type-icon-option' value={icon}>
    ...
    return (
      <section className='step-container'>
        <div className='mdl-grid'>
          <div className='mdl-cell mdl-cell--12-col'>
            <FormControl fullWidth className=''>
              <TextField required id='name' label='Name' InputLabelProps={this.InputLabelProps} value={name || ''} onChange={this.handleChange('name')}/>
            </FormControl>
          </div>
        </div>
        <div className='mdl-grid'>
          ...
          <div className='mdl-cell mdl-cell--6-col'>
            <FormControl fullWidth className=''>
              ...
              <Select value={tenant_id || activeTenant.id} onChange={this.handleChange('tenant_id')}>
        ...
        <div className='mdl-grid'>
          <div className='mdl-cell mdl-cell--12-col'>
            <FormControl fullWidth className=''>
              <TextField required id='description' label='Description' InputLabelProps={this.InputLabelProps} placeholder='This Content Type is for . . . ' helperText='Full width!' value={description || ''} onChange={this.handleChange('description')}/>
            </FormControl>
          </div>
        </div>

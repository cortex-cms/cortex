...
class Step extends React.PureComponent {
  ...
  render() {
    ...
    return (
      <Card>
        <CardHeader title={`Step ${index + 1}`} subheader={
          <span className='side-buttons' onClick={ expandStep}>
          Expand Step : <i className='material-icons'>{expandedStep === index ? 'expand_less' : 'expand_more'}</i>
         </span>
       }
       />
            ...
            <div className='mdl-grid'>
              <div className='mdl-cell mdl-cell--4-col'>
                <FormControl fullWidth className=''>
                  <TextField required id='name' label='Step Name' value={name || ''} onChange={this.handleChange('name')}/>
                </FormControl>
              </div>
              <div className='mdl-cell mdl-cell--8-col'>
                <FormControl fullWidth className=''>
                  <TextField id='heading' label='Step Heading' value={heading || ''} onChange={this.handleChange('heading')}/>
                </FormControl>
              </div>
              <div className='mdl-cell mdl-cell--12-col'>
                <FormControl fullWidth className=''>
                  <TextField id='description' label='Step Description' value={description || ''} onChange={this.handleChange('description')}/>
                </FormControl>
              </div>
              <div className='mdl-cell mdl-cell--12-col'>
                <b>Columns:</b>

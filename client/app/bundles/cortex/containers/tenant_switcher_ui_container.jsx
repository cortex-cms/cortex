...
import TenantUIList from 'components/side_bar/tenant_ui_list'
...
class TenantSwitcherUIContainer extends React.PureComponent {
  constructor(props) {
    super(props);
...
export default TenantSwitcherUIContainer

...
Gem::Specification.new do |s|
  ...
  #s.add_dependency 'cortex-plugins-core', path: '/Users/atharp/Repos/cortex-plugins-core' # TODO: this is an awkward dependency, but necessary until we clean up hardcoded references to Plugins::Core
  ...
  # JavaScript
  s.add_dependency 'gon', '~> 6.2.0'
  s.add_dependency 'react_on_rails', '9.0.3'
  s.add_dependency 'mini_racer'
  s.add_dependency 'webpacker'

  # Feature Flagging
  s.add_dependency 'flipper', '~> 0.11'
  s.add_dependency 'flipper-ui', '~> 0.11'
  s.add_dependency 'flipper-active_record', '~> 0.11'
end
